...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioMute", function () awful.util.spawn("amixer -c 1 set Speaker toggle") end),
    ...
    awful.key({ modkey,           }, "b", function () awful.util.spawn("firefox") end,
              {description = "open firefox", group = "sofian"}),
    ...
    awful.key({ modkey }, "d", function () awful.util.spawn("dmenu_run") end,
              {description = "run dmenu", group = "sofian"}),
    -- Menubar
...
awful.spawn.with_shell("/home/sofian/.config/polybar/launch.sh")
